  ...
  return (
    <Layout>
      <div ref={containerRef} className="relative bg-background selection:bg-accent selection:text-primary overflow-hidden">
            ...
            >
              ...
              >
                <Link to="/questionnaire">
                  <Button variant="hero" className="h-14 px-10 rounded-xl text-lg font-bold">
          ...
          <div className="container mx-auto relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-6 h-auto md:h-[800px]">
              ...
              <motion.div
                ...
                className="bg-accent p-8 rounded-3xl flex flex-col justify-center relative overflow-hidden shadow-elegant group"
              >
                ...
                <h4 className="font-display text-6xl font-bold text-primary mb-2">120+</h4>
                <p className="text-primary/80 font-bold uppercase tracking-wider">Years of Heritage</p>
              ...
              <motion.div
                ...
                className="bg-primary p-8 rounded-3xl flex flex-col justify-center relative overflow-hidden shadow-elegant"
              >
                <div className="absolute inset-0 court-pattern opacity-50" />
                <Users className="w-12 h-12 text-accent mb-6 relative z-10" />
                <h4 className="font-display text-3xl font-bold text-primary-foreground mb-2 relative z-10">The Houses</h4>
                <p className="text-primary-foreground/60 mb-6 text-sm leading-relaxed relative z-10">
                  Elgon, Athi, Serengeti, Baringo, Kirinyaga, Marsabit, Naivasha, Tana.
                </p>
                <Link to="/houses" className="inline-flex items-center text-accent hover:text-primary-foreground transition-colors font-bold text-sm uppercase tracking-widest relative z-10">
        ...
        {/* --- STATS STRIP --- */}
        <section className="bg-primary py-16 lg:py-20 border-y border-primary-foreground/5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-primary-foreground/10">
              {stats.map((stat, i) => (
                <div key={i} className="px-8 py-8 md:py-0 text-center">
                  <h3 className="font-display text-4xl md:text-5xl font-bold text-primary-foreground mb-2">{stat.value}</h3>
                  <p className="text-accent font-bold uppercase tracking-widest mb-2">{stat.label}</p>
                  <p className="text-primary-foreground/40 text-sm">{stat.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-24 lg:py-32 bg-background overflow-hidden">
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-16">
            <div className="md:w-1/2 space-y-8">
              <span className="text-accent font-bold tracking-widest uppercase text-sm">Timeless Tradition</span>
              ...
              <Link to="/history">
                <Button variant="default" className="rounded-xl px-8 py-6 text-lg mt-4">
                  View Full Timeline
                </Button>
              </Link>
            </div>
            <div className="md:w-1/2 relative">
              ...
              <div className="relative z-10 grid grid-cols-2 gap-4">
                <img src={heroImage} alt="Nairobi School campus" className="rounded-2xl shadow-lg object-cover h-64 md:h-80 transform translate-y-12" />
                <img src={heroImage} alt="Nairobi School grounds" className="rounded-2xl shadow-lg object-cover h-64 md:h-80 object-top" />
              </div>
            </div>
          </div>
        </section>
        ...
        {/* --- FOOTER CTA --- */}
        <section className="py-24 lg:py-32 bg-primary relative overflow-hidden text-center px-4">
          ...
          >
            <Quote className="w-16 h-16 text-accent mx-auto opacity-50" />
            <h2 className="font-display text-4xl md:text-6xl font-bold text-primary-foreground leading-tight">
              "To The Uttermost"
            </h2>
            <p className="text-primary-foreground/60 text-xl md:text-2xl">
              Your story is missing. Help us complete the picture.
            </p>
            <Link to="/questionnaire">
              <Button variant="hero" className="text-xl px-12 py-8 rounded-xl">
